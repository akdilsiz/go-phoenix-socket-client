...
func TestDefaultSocketOptions(t *testing.T) {
	...
	assert.Equal(t, "*go_phoenix_socket_client.serializer", reflect.TypeOf(defaultSocketOptions.Encode).String())
	assert.Equal(t, "*go_phoenix_socket_client.serializer", reflect.TypeOf(defaultSocketOptions.Decode).String())
